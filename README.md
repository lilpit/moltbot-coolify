...
| Volume | Path | Purpose |
|--------|------|---------|
| `openclaw-config` | `/home/node/.clawdbot` | Configuration & credentials |
| `openclaw-workspace` | `/home/node/clawd` | Agent workspace |
| `openclaw-claude` | `/home/node/.claude` | Claude Code credentials |
